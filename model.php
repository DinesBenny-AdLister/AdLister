...

{
    ...
    public function insert()
        {
            $insertQuery = "INSERT INTO". static::table. "(first_name, last_name, username, email, password)
                                                        VALUES(:first_name, :last_name, :username, :email, :password)";


            $insert self::$dbc->$query($insertQuery);

            $insert->bindValue(":first_name", $this->first_name, PDO::PARAM_STR);
            $insert->bindValue(":last_name", $this->last_name, PDO::PARAM_STR);
